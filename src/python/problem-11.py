...
grid.append([67 ,26, 20, 68, 02, 62, 12, 20, 95, 63, 94, 39, 63, 8, 40, 91, 66, 49, 94, 21]);
...
def sum(r,c,s1,s2):
	i=0;
	sum=1;
	while(i<4 and r+s1*i>=0 and c+s2*i>=0  and r+i*s1<20 and c+i*s2<20):
		sum*=grid[r+i*s1][c+i*s2]
		i+=1	
	return sum
...
for i in range(0,len(grid)):
	for j in range(0,len(grid[0])):
		...
		sh=sum(i,j,0,1);
		sda=sum(i,j,1,-1);
		maxs=max(max(maxs,sdi),max(max(sd,sh),sda));
